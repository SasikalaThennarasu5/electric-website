...
{banners.map((banner) => (
  <div
    key={banner.id}
    className="relative w-full flex flex-col items-center text-center font-[Lato]"
  >
    {/* 🔹 Blue SVG Blob Background */}
    <div className="relative w-full bg-white overflow-hidden">
      ...
      <div className="relative z-10 flex justify-center">
        <img
          ...
          alt={banner.title}
          className="w-full md:w-[70%] h-auto object-contain mx-auto mt-10"
        />
      </div>
    </div>

    {/* 🔹 Overlay Section */}
    <div className="relative z-20 -mt-12 bg-[#1E1E1E] w-[90%] md:w-[85%] mx-auto rounded-t-3xl shadow-lg pb-10 pt-12">
      <h1 className="text-2xl md:text-3xl font-bold text-[#E25C26]">
        {banner.title}
      </h1>
      <p className="mt-3 text-white text-base md:text-lg max-w-3xl mx-auto font-semibold">
        {banner.subtitle}
      </p>
    </div>
  </div>
      ...
      {/* 🔹 Why Choose Us Section */}
       <h2 className="text-2xl text-[#F65616] font-bold text-center mb-6">
  Why choose Us?
</h2>
